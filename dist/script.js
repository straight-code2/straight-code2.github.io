...
const Menu = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("li", null, /*#__PURE__*/
    React.createElement("a", { href: "./admin/services/index.html", onClick: props.toggleMenu }, "SERVICES")), /*#__PURE__*/
...
const About = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("h4", { className: "subtitle" }, "My name is straight-code & This is straight-code2"), /*#__PURE__*/
    React.createElement("p", null, "I am a web developer and UX designer based in the UK."), /*#__PURE__*/



    React.createElement("p", null, "I really enjoy solving problems as well as making things pretty and easy to use. I can't stop learning new things; the more, the better. I also love contributing to the open-source community. Oh, and Flaming Hot Monster Munch; My favourite!")), /*#__PURE__*/
    ...
    React.createElement("h4", { className: "subtitle" }, "I'm a programmer. I say No Stack To Full Stack"), /*#__PURE__*/
    React.createElement("p", null, "For the front-end I usually work with Javascript, either standalone or including popular frameworks like ReactJS and VueJS or sometimes i like working with Astro. I also make the web pretty by using Sass, CSS and, whenever needed, any of their friends: Bootstrap, Bulma, etc."), /*#__PURE__*/




    React.createElement("p", null, "For the back-end I also work with Javascript (NodeJS, Express, MongoDB, Git, etc). But, of course, whenever the project requires PHP, I do PHP as well (Wordpress, Laravel, etc).")), /*#__PURE__*/
    ...
    React.createElement("p", null, "I feel comfortable working with many Adobe products. Photoshop, Illustrator, Lightroom or Xd are some kind of industry standards and I love working with them. I'm not limited to them, though: Gimp, Inkscape, Blender or Figma are also very valid applications that I've been working with."), /*#__PURE__*/





    React.createElement("p", null, "User interfaces, brochures, moblie app, emails, branding... You name it! As I mentioned, creating pretty things is particularly important for me."))))));
...
const Projects = props => {
  return /*#__PURE__*/(
    ...
    ' ', /*#__PURE__*/
    React.createElement("a", { href: "https://straight-code-blog.netlify.app", target: "_blank", rel: "noopener noreferrer" }, "straight-code-blog"), ", where I've been coding for almost 7 months non-stop until I completed all the projects required to get my Full-Stack Developer certification.")), /*#__PURE__*/
    ...
    React.createElement(Project, {
      title: "straight-code blog.",
      img: 'https://straight-code.github.io/assets/blog.png',
      tech: "js css react node",
      link: "https://straight-code-blog.netlify.app",
      repo: "https://github.com/straight-code/blog" }, /*#__PURE__*/

    React.createElement("small", null, "Built using Node, astro, CSS and React Router."), /*#__PURE__*/
    ...
    React.createElement(Project, {
            title: "Github Clone.",
      img: 'https://straight-code.github.io/assets/github-clone.png',
      tech: "js react css",
      link: "https://straight-code-github-clone.netlify.app/",
      repo: "https://github.com/straight-code/github-clone" }, /*#__PURE__*/

    React.createElement("small", null, "Built using React and CSS."), /*#__PURE__*/
    React.createElement("p", null, "A github clone made from React."))))));
